...
Textline title;		//タイトル
Textline textline;	//評価文字列
Textline score1;	//スコア桁　十万
Textline score2;	//スコア桁　万
Textline score3;	//スコア桁　千
Textline score4;	//スコア桁　百
Textline score5;	//スコア桁　十
Textline score6;	//スコア桁　一

FullwidthUnit g_arrow;		//矢印
Textline g_back_to_title;	//タイトルに戻る文字列
Textline g_quit_game;		//ゲーム終了文字列
